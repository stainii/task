...
public class AbstractIntegrationTestCases {
    ...
    static {
        ...
        // moving it silently; #25 removed the duplicate so Renovate cannot move it silently either.
        // See ComposeFile.
        keycloakContainer = new KeycloakContainer(ComposeFile.imageOf("keycloak"))
